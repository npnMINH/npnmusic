...
const app = {
    ...
    songs: [
        {
            name: 'Hành khúc Đại học Mở Hà Nội',
            singer: 'V.A',
            path: './assets/music/hanhkhucdaihocmohanoi.mp3',
            image:'./assets/img/song7.jpg'
        },
        {
            name: 'Mong ước kỷ niệm xưa',
            singer: 'Tam Ca 3A',
            path: './assets/music/monguockyniemxua.mp3',
            image:'./assets/img/song8.jpg'
        },
        {
            name: 'Đón bình minh',
            singer: 'Phạm Anh Duy',
            path: './assets/music/donbinhminh.mp3',
        ...
        },
        {
            ...
            singer: 'Trúc Nhân',
            path: './assets/music/cuocsongmuonmau.mp3',
            image:'./assets/img/song11.jpg'
        },
        {
            name: 'Mỗi ngày tôi chọn một niềm vui',
            singer: 'Trịnh Công Sơn',
            path: './assets/music/moingaytoichonmotniemvui.mp3',
